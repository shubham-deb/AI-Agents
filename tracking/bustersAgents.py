...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        v = float("inf")
        finalpos = None
        for ghost in localMax:
            val = v
            v = self.distancer.getDistance(pacmanPosition, ghost)
            if val >v:
                finalpos = ghost
            else:
                v = val
        ...
        for a in legal:
            loc = Actions.getSuccessor(pacmanPosition, a)
            temp.append((self.distancer.getDistance(loc, goalCoordinate), a))
